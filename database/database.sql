...
INSERT INTO EmpresasAcciones (simbolo, nombre, pais, precio, simbolo_moneda, nombre_moneda, subida_bajada)
VALUES
('AAPL', 'Apple Inc.', 'Estados Unidos', 172.34, 'USD', 'Dólar estadounidense', 'Subida'),
('GOOG', 'Alphabet Inc. (Google)', 'Estados Unidos', 2432.45, 'USD', 'Dólar estadounidense', 'Bajada'),
('MSFT', 'Microsoft Corporation', 'Estados Unidos', 305.98, 'USD', 'Dólar estadounidense', 'Subida'),
('AMZN', 'Amazon.com, Inc.', 'Estados Unidos', 129.78, 'USD', 'Dólar estadounidense', 'Bajada'),
('TSLA', 'Tesla, Inc.', 'Estados Unidos', 889.43, 'USD', 'Dólar estadounidense', 'Subida'),
('BABA', 'Alibaba Group Holding Limited', 'China', 245.67, 'CNY', 'Yuan chino', 'Bajada'),
('TSMC', 'Taiwan Semiconductor Manufacturing Company', 'Taiwán', 678.32, 'TWD', 'Nuevo dólar taiwanés', 'Subida'),
('NVDA', 'NVIDIA Corporation', 'Estados Unidos', 589.34, 'USD', 'Dólar estadounidense', 'Bajada'),
('BRK.A', 'Berkshire Hathaway Inc.', 'Estados Unidos', 461234.56, 'USD', 'Dólar estadounidense', 'Subida'),
('JPM', 'JPMorgan Chase & Co.', 'Estados Unidos', 134.23, 'USD', 'Dólar estadounidense', 'Bajada'),
('AVV', 'Grupo Nutresa S.A.', 'Colombia', 2345.67, 'COP', 'Peso colombiano', 'Subida'),
('CORF', 'Grupo Éxito S.A.', 'Colombia', 1234.56, 'COP', 'Peso colombiano', 'Bajada'),
('PQD', 'Grupo Sura S.A.', 'Colombia', 876.54, 'COP', 'Peso colombiano', 'Subida'),
('BOV', 'Bancolombia S.A.', 'Colombia', 567.89, 'COP', 'Peso colombiano', 'Bajada'),
('ECOP', 'Ecopetrol S.A.', 'Colombia', 345.67, 'COP', 'Peso colombiano', 'Subida'),
('CEL', 'Centros Eléctricos Colombianos S.A. ESPB', 'Colombia', 234.56, 'COP', 'Peso colombiano', 'Bajada'),
('ISA', 'Interconexión Eléctrica S.A. ESPB', 'Colombia', 123.45, 'COP', 'Peso colombiano', 'Subida'),
('EPM', 'Empresas Públicas de Medellín E.S.P.', 'Colombia', 876.54, 'COP', 'Peso colombiano', 'Bajada'),
('GEB', 'Generadora Colombiana de Energía S.A.', 'Colombia', 567.89, 'COP', 'Peso colombiano', 'Subida'),
('CNO', 'Canacol Energy Ltd.', 'Colombia', 345.67, 'COP', 'Peso colombiano', 'Bajada'),
('CCH', 'Cementos Argos S.A.', 'Colombia', 234.56, 'COP', 'Peso colombiano', 'Subida'),
('GRIN', 'Grupo Nutresa S.A.', 'Colombia', 123.45, 'COP', 'Peso colombiano', 'Bajada'),
('VAL', 'Valorem S.A.', 'Colombia', 876.54, 'COP', 'Peso colombiano', 'Subida'),
('PAC', 'Constructora Bolívar S.A.', 'Colombia', 567.89, 'COP', 'Peso colombiano', 'Bajada'),
('BIM', 'Constructora Carlos Alberto Uribe S.A.', 'Colombia', 345.67, 'COP', 'Peso colombiano', 'Subida'),
('AMX', 'América Móvil, S.A.B. de C.V.', 'México', 17.45, 'MXN', 'Peso mexicano', 'Subida'),
('TELCEL', 'Telecomunicaciones Celulares del Noroeste, S.A. de C.V.', 'México', 52.34, 'MXN', 'Peso mexicano', 'Bajada'),
('TELMEX', 'Teléfonos de México, S.A. de C.V.', 'México', 8.76, 'MXN', 'Peso mexicano', 'Subida'),
('GFAM', 'Grupo Televisa, S.A.B. de C.V.', 'México', 234.23, 'MXN', 'Peso mexicano', 'Bajada'),
('ALSE', 'Alsea, S.A.B. de C.V.', 'México', 45.67, 'MXN', 'Peso mexicano', 'Subida'),
('WALMEX', 'Walmart de México, S.A.B. de C.V.', 'México', 134.56, 'MXN', 'Peso mexicano', 'Bajada'),
('SORL', 'Soriana, S.A.B. de C.V.', 'México', 34.23, 'MXN', 'Peso mexicano', 'Subida'),
('LIVEPOL', 'Grupo Coppel, S.A.B. de C.V.', 'México', 123.45, 'MXN', 'Peso mexicano', 'Bajada'),
('FEMSA', 'Fomento Económico Mexicano, S.A.B. de C.V.', 'México', 145.67, 'MXN', 'Peso mexicano', 'Subida'),
('GFBanorte', 'Grupo Financiero Banorte, S.A.B. de C.V.', 'México', 23.45, 'MXN', 'Peso mexicano', 'Bajada'),
('BBVA', 'BBVA México, S.A., Institución de Banca Múltiple', 'México', 18.76, 'MXN', 'Peso mexicano', 'Subida'),
('SANMEX', 'Santander México, S.A., Institución de Banca Múltiple', 'México', 12.34, 'MXN', 'Peso mexicano', 'Bajada'),
('AUCH', 'Banco Autofin México, S.A., Institución de Banca Múltiple', 'México', 14.56, 'MXN', 'Peso mexicano', 'Subida');
